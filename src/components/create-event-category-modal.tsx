...
const EVENT_CATEGORY_VALIDATOR = z.object({
    ...
    color: z.string().min(1, "Color is required.").regex(/^#[0-9-A-F]{6}$/i, "Invalid color."),
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        <Input autoFocus id="name" {...register("name")}
                        ...
                        <div className="flex flex-wrap gap-3 pt-1">
                            {EMOJI_OPTIONS.map(({ emoji, label }) => (
                                <button key={emoji} type="button" className={cn(
                                    "size-10 flex items-center justify-center text-xl rounded-md transition-all", selectedEmoji === emoji ? "bg-brand-100 ring-2 ring-brand-700 scale-110" : "bg-brand-100 hover:bg-brand-200")}
