...
import { DashboardEmptyState } from "./dashbooard-empty-state"
                        ...
                        <div className="relative p-6 z-10">
                            ...
                            <div className="flex items-center justify-between mt-4">
                                ...
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="text-gray-500 hover:text-red-600 transition-colours" aria-label={`Delete ${category.name} category`}
            ...
            >
                <div className="space-y-6 text-center">
                    <div>
                        ...
                        <p className="text-sm/6 text-gray-600">
                            Are you sure you want to delete the {deletingCategory} category? This action cannot be undone
                        </p>
                    </div>
